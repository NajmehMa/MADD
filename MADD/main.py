...
# Add nodes (datasets)
node1 = Node(1, SkullImageSegmentationDataset(data_paths=['datasets/mri_skull_stripping_dataset/']))
node2 = Node(3, ImageClassificationDataset(data_paths=['datasets/adni_mri_classification_dataset/']))
