...
class ImageClassificationDataset:
    def __init__(self, data,image_size=(256,256)):
        ...
        self.train_set = ImageDataset(split='train', data=data, transform=train_transforms)
        self.test_set = ImageDataset(split='test', data=data, transform=self.test_transforms)
    ...
    def get_inference_set(self,inference_sample):
        inference_set = ImageDataset(split='', data=inference_sample, transform=self.test_transforms)
