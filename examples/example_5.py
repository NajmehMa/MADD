...
# Add nodes (datasets)
node1 = Node(1, CognitiveDataset(data='/home/azargari/modular-metalearning/final_scripts/MADD/datasets/vad_dataset/'))
...
edge1 = Edge(3, CognitiveClassificationModel(ckpt="/home/azargari/modular-metalearning/final_scripts/MADD/chekpoints/cognitive_classifier_ckpt.pt"
...
print(test_results)
predict_results=my_graph.predict_edge_models_by_id(edge_id_list,inference_sample="/home/azargari/modular-metalearning/final_scripts/MADD/inference_samples/cognitive_samples/inference_samples_1.csv")
