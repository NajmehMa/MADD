...
# Add nodes (datasets)
node1 = Node(1, SurfaceDataset(data='/home/azargari/modular-metalearning/final_scripts/MADD/datasets/surface_dataset/'))
...
edge1 = Edge(3, SurfaceClassificationModel(ckpt="/home/azargari/modular-metalearning/final_scripts/MADD/chekpoints/surface_classifier_ckpt.pt"
...
print(test_results)
predict_results=my_graph.predict_edge_models_by_id(edge_id_list,inference_sample="/home/azargari/modular-metalearning/final_scripts/MADD/inference_samples/surface_samples/inference_samples_1.csv")
