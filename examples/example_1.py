...
# Add nodes (datasets)
node1 = Node(1, AgeDataset(data='/home/azargari/modular-metalearning/final_scripts/MADD/datasets/age_dataset/'))
...
edge1 = Edge(3, AgeClassificationModel(ckpt="/home/azargari/modular-metalearning/final_scripts/MADD/chekpoints/age_classifier_ckpt.pt"
...
edge_id_list = [3]  # Replace with the ids of the edge you want to train
...
print(test_results)
predict_results=my_graph.predict_edge_models_by_id(edge_id_list,inference_sample="/home/azargari/modular-metalearning/final_scripts/MADD/inference_samples/age_samples/inference_samples_1.csv")
