...
# Add nodes (datasets)
node1 = Node(1, AgeDataset(data='/home/azargari/modular-metalearning/final_scripts/MADD/datasets/APOE4_gene_dataset/'))
...
edge1 = Edge(3, AgeClassificationModel(ckpt="/home/azargari/modular-metalearning/final_scripts/MADD/chekpoints/APOE4_gene_classifier_ckpt.pt"
...
print(test_results)
predict_results=my_graph.predict_edge_models_by_id(edge_id_list,inference_sample="/home/azargari/modular-metalearning/final_scripts/MADD/inference_samples/APOE4_gene_samples/inference_samples_1.csv")
