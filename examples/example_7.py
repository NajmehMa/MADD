...
# Add nodes (datasets)
node1 = Node(1, PETNormalizedMeasDataset(data='/home/azargari/modular-metalearning/final_scripts/MADD/datasets/pet_normalized_meas_dataset/'))
...
edge1 = Edge(3, PETNormalizedMeasClassificationModel(ckpt="/home/azargari/modular-metalearning/final_scripts/MADD/chekpoints/pet_normalized_meas_classifier_ckpt.pt"
...
print(test_results)
predict_results=my_graph.predict_edge_models_by_id(edge_id_list,inference_sample="/home/azargari/modular-metalearning/final_scripts/MADD/inference_samples/pet_normalized_meas_samples/inference_samples_1.csv")
